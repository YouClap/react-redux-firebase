...
export const actionTypes = {
  ...
  FILE_GET_DOWNLOAD_URL_START: `${actionsPrefix}/FILE_GET_DOWNLOAD_URL_START`,
  FILE_GET_DOWNLOAD_URL_ERROR: `${actionsPrefix}/FILE_GET_DOWNLOAD_URL_ERROR`,
  FILE_GET_METADATA_START: `${actionsPrefix}/FILE_GET_METADATA_START`,
  FILE_GET_METADATA_ERROR: `${actionsPrefix}/FILE_GET_METADATA_ERROR`,
